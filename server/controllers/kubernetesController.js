...
var kubernetesController = {
  totalRestarts: function (req, res, next) {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              next({
                log: 'Error in kuberenetesController.getTotalRestarts: '.concat(
                  err_1
                ),
                status: 500,
  ...
  namespaceNames: function (req, res, next) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              next({
                log: 'Error in kuberenetesController.nameSpaceNames: '.concat(
                  err_2
                ),
                status: 500,
  ...
  podNames: function (req, res, next) {
    return __awaiter(void 0, void 0, void 0, function () {
  ...
  podsNotReady: function (req, res, next) {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              next({
                log: 'Error in kuberenetesController.podsNotReady: '.concat(
                  err_4
                ),
                status: 500,
  ...
  getNameSpaceMetrics: function (req, res, next) {
    return __awaiter(void 0, void 0, void 0, function () {
      var objectData,
        namespaceName,
        ccNamespaceName,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            ccNamespaceName = namespaceName.replace(/-([a-z])/g, function (g) {
              return g[1].toUpperCase();
            });
            console.log(ccNamespaceName);
            restartQuery =
              'sum(changes(kube_pod_status_ready{condition="true", namespace = "'.concat(
                ccNamespaceName,
                '"}[5m]))'
              );
            readyQuery =
              'sum(kube_pod_status_ready{condition="false", namespace = "'.concat(
                ccNamespaceName,
                '"})'
              );
            cpuQuery =
              'sum(rate(container_cpu_usage_seconds_total{container="", namespace=~"'.concat(
                ccNamespaceName,
                '"}[10m]))'
              );
            memQuery =
              'sum(rate(container_memory_usage_bytes{container="", namespace=~"'.concat(
                ccNamespaceName,
                '"}[10m]))'
              );
            receiveQuery =
              'sum(rate(node_network_receive_bytes_total{namespace = "'.concat(
                ccNamespaceName,
                '"}[10m]))'
              );
            transmitQuery =
              'sum(rate(node_network_transmit_bytes_total{namespace = "'.concat(
                ccNamespaceName,
                '"}[10m]))'
              );
            _a.label = 1;
          ...
          case 8:
            ...
            return [
              2 /*return*/,
              next({
                log: 'Error in kuberenetesController.getMetrics: '.concat(
                  err_5
                ),
                status: 500,
  ...
  getPodMetrics: function (req, res, next) {
    return __awaiter(void 0, void 0, void 0, function () {
      var objectData,
        podName,
        ccPodName,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            console.log(podName);
            restartQuery =
              'sum(changes(kube_pod_status_ready{condition="true", pod = "'.concat(
                podName,
                '"}[5m]))'
              );
            readyQuery =
              'sum(kube_pod_status_ready{condition="false", pod = "'.concat(
                podName,
                '"})'
              );
            cpuQuery =
              'sum(rate(container_cpu_usage_seconds_total{container="", pod=~"'.concat(
                podName,
                '"}[10m]))'
              );
            memQuery =
              'sum(rate(container_memory_usage_bytes{container="", pod=~"'.concat(
                podName,
                '"}[10m]))'
              );
            receiveQuery =
              'sum(rate(node_network_receive_bytes_total{pod = "'.concat(
                podName,
                '"}[10m]))'
              );
            transmitQuery =
              'sum(rate(node_network_transmit_bytes_total{pod = "'.concat(
                podName,
                '"}[10m]))'
              );
            _a.label = 1;
